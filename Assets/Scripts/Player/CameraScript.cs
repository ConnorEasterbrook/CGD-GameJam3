...
public class CameraScript : MonoBehaviour
{
	...
	*/
    ...
    void Update()
    {
		...
		rotation = Quaternion.Euler(rotation.eulerAngles.x - Input.GetAxisRaw("Mouse Y") * sensitivity/2,
            rotation.eulerAngles.y + Input.GetAxisRaw("Mouse X") * sensitivity, rotation.eulerAngles.z);
